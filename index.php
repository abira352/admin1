    ...
    <div class="container">
        <div class="header">
            ...
            <div class="nav-links">
                ...
                <a href="?page=view" class="nav-link <?php echo $current_page == 'view' ? 'active' : ''; ?>">👁️ View Products</a>
                <a href="?page=manage" class="nav-link <?php echo $current_page == 'manage' ? 'active' : ''; ?>">⚙️ Manage Products</a>
            </div>
        </div>
